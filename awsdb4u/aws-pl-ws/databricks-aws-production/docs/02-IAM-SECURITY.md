...
3. [Unity Catalog Roles](#3-unity-catalog-roles)
4. [Instance Profile Role](#4-instance-profile-role)
5. [KMS Encryption Policies](#5-kms-encryption-policies)
6. [Pre-Creation Guide](#6-pre-creation-guide)
...
flowchart TD
    ...
    style UC fill:#1B72E8,color:#fff
    style ROLE fill:#FF9900,color:#000
```
...
### 3.2 External Location Role (Per-Workspace)
...
flowchart LR
    ...
    style CLUSTER fill:#569A31,color:#fff
    style ROLE fill:#FF9900,color:#000
```
...
## 5. KMS Encryption Policies

### 5.1 KMS Policy Architecture
...
flowchart TD
    ...
    style KMS fill:#569A31,color:#fff
    style POL1 fill:#FF9900,color:#000
    style POL2 fill:#FF9900,color:#000
```
...
## 6. Pre-Creation Guide

### 6.1 Roles That Can Be Pre-Created
