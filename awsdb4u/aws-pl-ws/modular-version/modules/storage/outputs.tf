...
output "unity_catalog_root_storage_bucket" {
  ...
  value       = aws_s3_bucket.unity_catalog_root_storage.bucket
}

output "unity_catalog_root_storage_bucket_arn" {
  description = "Unity Catalog root storage bucket ARN"
  value       = aws_s3_bucket.unity_catalog_root_storage.arn
}
