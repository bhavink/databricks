...
***REMOVED******REMOVED******REMOVED*** databricks rest api for cluster policy
...
***REMOVED******REMOVED******REMOVED*** Please note that in order to run these collection you'll need at-least one object of each type i.e. cluster, job, notebook, directory, instance-pool.
