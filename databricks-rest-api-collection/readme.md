***REMOVED*** databricks rest api collections
...
***REMOVED******REMOVED******REMOVED*** Azure / AWS Databricks:
- Generate a databricks platform token aka PAT for [azure](https://docs.microsoft.com/en-us/azure/databricks/dev-tools/api/latest/authentication***REMOVED***authentication) or [aws](https://docs.databricks.com/dev-tools/api/latest/authentication.html***REMOVED***generate-a-token)

***REMOVED******REMOVED******REMOVED*** Azure Databricks
...
***REMOVED******REMOVED******REMOVED*** Using postman collections
