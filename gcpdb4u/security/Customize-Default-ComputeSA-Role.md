...
***REMOVED******REMOVED******REMOVED*** Get current role’s assigned to default compute SA
...
***REMOVED******REMOVED******REMOVED*** Remove project editor role from default compute SA
```
...
```
***REMOVED******REMOVED******REMOVED*** Assign custom role to default compute SA
```
gcloud projects add-iam-policy-binding {{project-id}} \
--member='serviceAccount:{{project-number}}-compute@developer.gserviceaccount.com' \
--role='projects/{{project-id}}/roles/databricksComputeSA'
```
***REMOVED******REMOVED******REMOVED*** Validate current role’s assigned to default compute SA
...
***REMOVED******REMOVED******REMOVED*** Optionally, add stackdriver related role’s to the default compute SA for logging and monitoring
...
***REMOVED******REMOVED******REMOVED*** Validate roles assigned to default compute SA
