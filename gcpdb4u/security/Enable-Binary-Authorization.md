***REMOVED******REMOVED*** GCP Binary Auth for GKE clusters images
...
***REMOVED******REMOVED******REMOVED*** Disallow all images but exempt Databricks gcr repo
...
***REMOVED******REMOVED******REMOVED*** Edit policy for Binary Auth to disallow all images on Console
Console → Security → Binary Authorization → Edit Policy

![](./../images/enable-binauth2.png)

***REMOVED******REMOVED******REMOVED*** Add Databricks gcr repo to Binay Auth exempt images on Console

***REMOVED******REMOVED******REMOVED******REMOVED*** USA
...
***REMOVED******REMOVED******REMOVED******REMOVED*** EU
...
***REMOVED******REMOVED******REMOVED*** Edit Policy
![](./../images/enable-binauth5.png)

***REMOVED******REMOVED******REMOVED*** Databricks GKE cluster can only launch pods with images from authorized repo’s. 
![](./../images/enable-binauth6.png)

***REMOVED******REMOVED******REMOVED*** Verify cluster starts
