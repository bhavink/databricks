***REMOVED*** Enable Binary Authorization for GKE Cluster
...
***REMOVED******REMOVED*** Enable Binary Auth on the GKE cluster
![](./../images/enable-binauth1.png)

***REMOVED******REMOVED*** Edit policy for Binary Auth to disallow all images on Console
