***REMOVED*** CIS Recommended Best Practices
...
***REMOVED*** Validate CIS Recommended Best Practices

***REMOVED******REMOVED*** Ensure legacy Compute Engine instance metadata APIs are Disabled
...
```
***REMOVED******REMOVED*** Ensure Node Auto-Repair is enabled for GKE nodes
...
***REMOVED******REMOVED*** Ensure Node Auto-Upgrade is enabled for GKE nodes
...
***REMOVED******REMOVED*** Ensure Shielded GKE Nodes are Enabled
...
***REMOVED******REMOVED*** Ensure Integrity Monitoring for Shielded GKE Nodes is Enabled
...
***REMOVED******REMOVED*** Ensure Master Authorized Networks is Enabled
...
***REMOVED******REMOVED*** Ensure clusters are created with Private Nodes
...
***REMOVED******REMOVED*** Ensure Network Policy is Enabled and set as appropriate
