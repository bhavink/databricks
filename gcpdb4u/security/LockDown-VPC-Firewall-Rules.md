...
## Recommended egress allowlist (examples)
...
curl -I https://restricted.googleapis.com   # if using VPC SC
```
3. Confirm no other egress is possible:
```
curl -I https://example.com  # should fail if deny-all-egress is in place
```
