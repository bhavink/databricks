...
| asia-southeast1 | Shard: 163855694937 & 68422481410  Artifact: 643670579914  AuditLogDelivery: 85638097580 | <ul><li>Shard SA: shard-sa@prod-gcp-**asia-southeast1**.iam.gserviceaccount.com (Shard SA)  </li><li>shard-sa@prod-gcp-**us-central1**.iam.gserviceaccount.com (Backend Service SA)</li></ul>  **log-delivery**@databricks-prod-master.iam.gserviceaccount.com (Audit Log Delivery Service Account)  **as-gcr-access-sa**@databricks-prod-artifacts.iam.gserviceaccount.com (GCR Service Account)  db-**WORKSPACEID**@prod-gcp-**asia-southeast1**.iam.gserviceaccount.com (Consumer SA) </ul> |
