...
/*
Service account attached to the GCE cluster to spin up GCE nodes
...
# # assign role to the GCE default SA
...
output "service_account" {
    value       = "Default SA attached to GCE nodes ${google_service_account.databricks.email}"
}
