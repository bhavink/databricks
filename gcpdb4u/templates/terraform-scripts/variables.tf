...
***REMOVED*** This SA needs to be precreated and added to accounts.gcp.databricks.com with an admin role
...
***REMOVED*** This user will be added to newly created workspace as an admin user. You need to do this so that there exists
***REMOVED*** atleast one user with login access to the workspace
...
variable "databricks_account_id" {
    description = <<EOT
                ...
                EOT
    type = string
    default = "9fcbb245-7c44-4522-9870-e38324104cf8" ***REMOVED***e11e38c5-a449-47b9-b37f-0fa36c821612
}
