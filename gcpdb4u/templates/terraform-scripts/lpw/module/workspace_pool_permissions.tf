resource "databricks_permissions" "pool_usage" {
  ...
  ***REMOVED*** MODIFICATION - This resource assigns usage permissions for each instance pool to groups based on local.pool_usage_permissions_map.
  ***REMOVED*** Permissions are applied dynamically per pool and group.
  ...
  ***REMOVED*** MODIFICATION - permissions for pool access assigned dynamically per group and role via access_control block
