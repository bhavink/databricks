...
> - Is more operationally complex than the standard workspace templates
>
> **Before using this module:**
> 1. Review the VPC-SC policies in [`/templates/vpcsc-policy/least-privilege-workspaces/`](../../vpcsc-policy/least-privilege-workspaces/)
> 2. Confirm the maximum-security posture matches your requirements
>
...
>
> This module is intended for **highly regulated environments** (financial services, healthcare, government) where maximum security posture is a mandatory requirement.
