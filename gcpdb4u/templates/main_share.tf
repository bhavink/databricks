***REMOVED*** please make sure to substitue place holer values with your project specific values
***REMOVED*** for most upto date details, visit - https://registry.terraform.io/providers/databricks/databricks/latest/docs/guides/gcp-workspace
***REMOVED*** the following script assumes that the vpc/subnet is precreated

variable "databricks_account_id" {
  default = "DATABRICKS ACCOUNT ID"
}

***REMOVED*** host and service project could be same in case of using a single project
***REMOVED*** where the vpc resides within the same project as databricks gke cluster
...
***REMOVED*** make sure that the servcice account is added to databricks account console and is given accounts admin role
***REMOVED*** https://docs.gcp.databricks.com/administration-guide/index.html
