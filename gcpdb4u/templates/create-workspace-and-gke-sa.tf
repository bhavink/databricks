...
# databricks account id available on accounts console > clicked on the logged in user email (top right corner)
...
# in this example projectId and name are same, yours could be different
...
# assign custom role to the databricks gke
