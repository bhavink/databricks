...
resource "azurerm_databricks_workspace" "this" {
  ...
  # Customer-Managed Keys (CMK) - Enable flag required for storage_account_identity
...
# ==============================================
# Data Source: DBFS Storage Account
# ==============================================

# Retrieve DBFS storage account created by Databricks in the managed resource group
# Note: This data source will be read during apply, after workspace creation
...
# ==============================================
# DBFS Root Storage CMK Encryption
# ==============================================

# Key Vault Access Policy for DBFS Storage Account Identity
# This is required for DBFS CMK to work - the storage account's managed identity needs access to the Key Vault
# Note: storage_account_identity is created when customer_managed_key_enabled = true on the workspace
# See: https://github.com/hashicorp/terraform-provider-azurerm/blob/main/examples/databricks/customer-managed-key/dbfs/main.tf
...
# Customer-Managed Key for DBFS root storage account
# This resource applies CMK encryption to the workspace DBFS root storage
# See: https://github.com/hashicorp/terraform-provider-azurerm/blob/main/examples/databricks/customer-managed-key/dbfs/main.tf
...
# ==============================================
# Managed Disks CMK Encryption
# ==============================================

# Data source to find Disk Encryption Set (DES) created by Azure
# When managed_disk_cmk is enabled, Azure automatically creates a DES in the managed resource group
# We need to find it by querying the resources in the managed RG
# Reference: https://learn.microsoft.com/en-us/azure/databricks/security/keys/customer-managed-keys-managed-services-azure
...
# Data source to read the actual Disk Encryption Set details including identity
# The azurerm_resources data source only gives us the ID, we need the specific DES data source for identity
...
# Key Vault Access Policy for Disk Encryption Set Managed Identity
# This grants the DES permission to use the CMK for encrypting managed disks
# Without this, cluster startup will fail with: KeyVaultAccessForbidden
