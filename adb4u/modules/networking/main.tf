# ==============================================
# Data Sources (Existing Network Resources)
# ==============================================
...
# ==============================================
# Subnets with Databricks Delegation
# ==============================================
...
resource "azurerm_subnet" "public" {
  ...
  # Databricks delegation (REQUIRED)
  delegation {
  ...
  # Service Endpoints for Unity Catalog storage
  service_endpoints = [
    "Microsoft.Storage",
    "Microsoft.KeyVault",
  ]
...
# ==============================================
# Private Link Subnet (Full Private Pattern Only)
# ==============================================
...
resource "azurerm_subnet" "privatelink" {
  ...
  # NO Databricks delegation for Private Link subnet
  # NO NAT Gateway for Private Link subnet (air-gapped)
  # NO Service Endpoints (using Private Link for storage)
}

# Existing Private Link Subnet (BYOV)
...
# ==============================================
# Subnet Delegation for Existing Subnets
# ==============================================

# Ensure Databricks delegation exists on user-provided subnets
# Note: This is a protective measure. Azure will return error if delegation is missing.
# Terraform cannot directly add delegation to existing subnets via azurerm_subnet resource,
# so this must be validated via data source or handled by user.
# 
# IMPORTANT: User MUST ensure existing subnets have Microsoft.Databricks/workspaces delegation.
# See README for instructions on adding delegation to existing subnets.
