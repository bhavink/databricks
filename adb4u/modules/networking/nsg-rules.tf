...
#
# IMPORTANT: NSG rules are only created for PRIVATE LINK deployments.
# - For Non-PL: Azure Databricks automatically creates these rules (with "Microsoft.Databricks-workspaces_UseOnly_" prefix)
# - For Private Link: We must create these rules explicitly because public network access is disabled
#
