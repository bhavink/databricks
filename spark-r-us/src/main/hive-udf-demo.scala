...
// MAGIC %md
// MAGIC 
// MAGIC ***REMOVED******REMOVED******REMOVED*** This is based on excellent work done by one of our lead instructor Brian Clapper.
// MAGIC ***REMOVED******REMOVED******REMOVED*** Source code along with details instructions is located over here https://github.com/bmc/spark-hive-udf/
