...
See `SETUP.md` for the complete zero-to-running bootstrap guide.
...
The showcase includes a full observability stack built on MLflow Tracing and Unity Catalog:

- **Trace archival** — All LLM and tool traces are archived to a Delta table for long-term analysis
- **Automated scoring** — 5 quality judges (safety, groundedness, relevance, guideline adherence, chunk relevance) run as MLflow scorers on every trace
- **Lakeview dashboard** — 4-page dashboard covering trace volume, latency distributions, scorer trends, and per-tab breakdowns
- **SQL alerts** — 3 automated alerts for safety failures, latency spikes, and error rate thresholds

See `observability/OBSERVABILITY.md` for full details on setup and configuration.
...
| `seed/` | Setup scripts: seeding data, UC grants, OAuth integration, test harness |
| `seed/README.md` | Seed script reference and execution order |
| `observability/` | Tracing, scoring, and dashboard deployment |
| `observability/tracing_config.py` | Trace archival and MLflow configuration |
| `observability/setup_scorers.py` | Automated quality judge setup |
| `observability/deploy_dashboard.py` | Lakeview dashboard deployment |
| `observability/correlation_queries.sql` | SQL queries for trace analysis and alerts |
| `docs/` | Technical reference documentation |
| `SETUP.md` | Complete zero-to-running bootstrap guide |
| `DEMO-GUIDE.md` | Full demo walkthrough, persona switching, and troubleshooting |
| `DEMO-SCRIPT.md` | Condensed demo script for live presentations |
