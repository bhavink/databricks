...
try:
    mlflow_tracking_uri = sys.argv[1]  # "databricks://adb-field-eng"
    data_file_location = sys.argv[2]  # "/databricks-datasets/amazon/data20K"
    scoring_data_file_location = sys.argv[3]  # "/databricks-datasets/amazon/test4K"
except:
    # parser.print_help()
