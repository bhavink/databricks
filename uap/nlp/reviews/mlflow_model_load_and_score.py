...
***REMOVED*** mlflow.set_experiment(mlflow_experiment_file_path)
***REMOVED*** client = mlflow.tracking.MlflowClient()
***REMOVED*** experiment_id = client.get_experiment_by_name(mlflow_experiment_file_path).experiment_id
...
***REMOVED*** here for test purpose

***REMOVED*** mlflow_experiment_file_path = "/Shared/experiments/bk-uap-reviews-dbconnect-exp"
***REMOVED*** mlflow_tracking_uri = "databricks://adb-field-eng"
***REMOVED*** mlflow_search_query = "metrics.accuracy >= 0.80"
***REMOVED*** scoring_data_file_location = "/databricks-datasets/amazon/test4K"

***REMOVED*** load_and_score_using_pyfunc(mlflow_experiment_file_path, mlflow_tracking_uri, mlflow_search_query,scoring_data_file_location)
