...
if __name__ == "__main__":
    ...
    ***REMOVED*** mlflow_tracking_uri = "databricks"
    ...
    ***REMOVED*** data_science.nostradamus()
    ...
    ***REMOVED*** data_engg.ingest_data(data_file_location)
    ***REMOVED*** mlflow_experiments.set_mlflow_tracking_uri(mlflow_tracking_uri)
    ***REMOVED*** mlflow_experiments.set_mlflow_experiment(mlflow_experiment_file_path)
    ***REMOVED*** cv_runid, cv_artifactUri = mlflow_experiments.model_selection_via_crossvalidation(numFeatures, regParam, netParam, cvNumFolds)
    ...
    ***REMOVED*** load_and_score_using_spark(mlflow_experiment_file_path, mlflow_tracking_uri, mlflow_search_query,
    ***REMOVED***                            scoring_data_file_location)
    ***REMOVED*** load_and_score_using_pyfunc(mlflow_experiment_file_path, mlflow_tracking_uri, mlflow_search_query,
    ***REMOVED***                             scoring_data_file_location)